...
import 'package:rebootOffice/model/statistics/statistics_state.dart';
import 'package:rebootOffice/view/base/base_screen.dart';
import 'package:rebootOffice/view_model/statistic_detail/statistic_detail_view_model.dart';
...
class StatisticsDetailScreen extends BaseScreen<StatisticDetailViewModel> {
  ...
  Widget _buildTaskDetail(Task task, bool isLastTask) {
    return Container(
